...
$$.InputElement = {"": "_HTMLElement;height=,name%,type=,value%,width=", $isElement: true, $asElement: null, $isEventTarget: true, $asEventTarget: null};
...
// Bound closures
$$.BoundClosure$i0 = {"": "BoundClosure;_self,_liblib5$_target,_liblib5$_receiver",
  call$0: function() {
    return this._self[this._liblib5$_target](this._liblib5$_receiver);
  }
};
...
$$.BoundClosure$i1 = {"": "BoundClosure;_self,_liblib5$_target,_liblib5$_receiver",
  call$1: function(p0) {
    return this._self[this._liblib5$_target](this._liblib5$_receiver, p0);
  }
};

$$.BoundClosure$2 = {"": "BoundClosure;_self,_liblib5$_target,_liblib5$_receiver",
...
_BaseSendPort: {"": "Object;_isolateId<",
  ...
  call$1: function(message) {
    ...
    port._liblib10$_callback = new $._BaseSendPort_call_closure(completer, port);
    return futureImpl;
  },
  $isFunction: true,
  $isSendPort: true
...
ReceivePortImpl: {"": "Object;_id<,_liblib10$_callback<",
...
_ConstantMapKeyIterable: {"": "IterableBase;_map",
  get$iterator: function(_) {
    return $.get$iterator$ax(this._map._liblib5$_keys);
  },
...
XAppointment: {"": "WebComponent;_css,__e1,__e4,__e5,__e2<,__e3<,__t,_time<,name*,number@,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, __binding0, t2;
    ...
    this.__e5 = $.$index$asx(t1.get$nodes(root), 1);
    this.__e4 = $.$index$asx($.get$nodes$x(this.__e5), 1);
    this.__e1 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e4), 1)), 1);
    __binding0 = this.__t.contentBind$2(new $.XAppointment_created_autogenerated_closure(this), false);
    $.addAll$1$ax($.get$nodes$x(this.__e1), [document.createTextNode("\n                "), __binding0, document.createTextNode("\n              ")]);
    this.__e2 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e4), 1)), 3);
    this.__t.listen$2($.get$onChange$x(this.__e2), new $.XAppointment_created_autogenerated_closure0(this));
    this.__t.listen$2($.get$onInput$x(this.__e2), new $.XAppointment_created_autogenerated_closure1(this));
    t1 = this.__t;
    t1.oneWayBind$4;
    ...
    this.__e3 = $.$index$asx($.get$nodes$x(this.__e4), 3);
    this.__t.listen$2($.get$onInput$x(this.__e3), new $.XAppointment_created_autogenerated_closure4(this));
    t1 = this.__t;
    t1.oneWayBind$4;
    t1.children.push(new $.DomPropertyBinding(new $.XAppointment_created_autogenerated_closure5(this), new $.XAppointment_created_autogenerated_closure6(this), false, false, null));
    t1 = this.__t;
    t2 = new $.Collapse(null, null, true, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t2.set$host(t2, this.__e4);
    t1.component$1;
...
XAppointment_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    var t1 = this.this_1;
    $.Primitives_printString("Name of " + $.S(t1.get$_time()) + " changed to: " + $.S($.get$name$x(t1)));
  },
  $isFunction: true
},
...
XAppointment_created_autogenerated_closure1: {"": "Closure;this_2",
  call$1: function($$event) {
    var t1 = this.this_2;
    $.set$name$x(t1, $.get$value$x(t1.get$__e2()));
  },
  $isFunction: true
},
...
XAppointment_created_autogenerated_closure2: {"": "Closure;this_4",
  call$1: function(e) {
    var t1 = this.this_4;
    if (!$.$eq($.get$value$x(t1.get$__e2()), e))
...
XAppointment_created_autogenerated_closure4: {"": "Closure;this_5",
  call$1: function($$event) {
    var t1 = this.this_5;
    t1.set$number($.get$value$x(t1.get$__e3()));
  },
  $isFunction: true
},
...
XAppointment_XAppointment: function(time) {
  var t1, appointment;
  if ($.XAppointment__cache == null) {
    t1 = new $.HashMap(0, null, null, null, null);
    t1.$builtinTypeInfo = [null, null];
    $.XAppointment__cache = t1;
  }
  if ($.XAppointment__cache.containsKey$1(time)) {
    t1 = $.XAppointment__cache;
    return t1.$index(t1, time);
  } else {
    appointment = new $.XAppointment(null, null, null, null, null, null, null, null, null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    appointment.set$host(appointment, $._ElementFactoryProvider_createElement_html("<x-appointment time=\"" + $.S(time) + "\"></x-appointment>"));
...
main0: function() {
  $.useObservers = false;
  $.main();
  var __t = new $.Template(document.body, [], []);
  __t.create$0();
  __t.insert$0(__t);
}}],
...
Size: {"": "Object;width>,height>",
  ...
  get$isEmpty: function(_liblib5$_receiver) {
    return new $.BoundClosure$i0(this, "isEmpty$0", _liblib5$_receiver);
  },
...
_ForwardingStream: {"": "Stream;",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    ...
    t4._liblib4$_subscription = t4._stream._liblib4$_source.listen$3$onDone$onError(t1, t4.get$_handleDone(), t2);
    return t4;
  },
...
_ForwardingStreamSubscription: {"": "_BufferingStreamSubscription;_stream,_liblib4$_subscription,_liblib4$_onData,_onError,_onDone,_zone,_state,_pending",
  _liblib4$_add$1: function(data) {
    if ((this._state & 2) !== 0)
      return;
...
HashMapKeyIterable: {"": "IterableBase;_liblib3$_map",
  get$length: function(_) {
    return this._liblib3$_map._liblib3$_length;
  },
  get$isEmpty: function(_) {
    return this._liblib3$_map._liblib3$_length === 0;
  },
  get$iterator: function(_) {
...
Uri: {"": "Object;_liblib12$_port,_path,scheme,userInfo,host>,query,fragment,_pathSegments,_queryParameters",
  ...
  _writeAuthority$1: function(ss) {
    ...
    str = typeof str === "string" ? str : $.S(str);
    ss._contents = ss._contents + str;
    if (!$.$eq(this._liblib12$_port, 0)) {
      ss._contents = ss._contents + ":";
      str = $.toString$0(this._liblib12$_port);
      str = typeof str === "string" ? str : $.S(str);
      ss._contents = ss._contents + str;
    }
  },
  ...
  get$hashCode: function(_) {
    ...
    return t1.call$2(this.scheme, t1.call$2(this.userInfo, t1.call$2(this.host, t1.call$2(this._liblib12$_port, t1.call$2(this._path, t1.call$2(this.query, t1.call$2(this.fragment, 1)))))));
  },
...
_AnimatingValues: {"": "Object;_liblib13$_element,_cleanupAction,_finishFunc,_completer,_liblib13$_timer",
...
ShowHide__requestShow: function(element, desiredDuration, effect, effectTiming) {
  ...
  if (durationMS > 0) {
    ...
    t4.$indexSet(t4, value._liblib13$_element, value);
    t4 = $.Duration$(0, 0, 0, durationMS, 0, 0);
    t1 = value.get$_complete();
    value._liblib13$_timer = $.get$_Zone__current().createTimer$2(t4, t1);
...
main: function() {
  ...
  for (i = 1; i <= 31; ++i) {
    ...
    $parent = document.querySelector(t1);
    for (h = 8; h <= 17; ++h)
...
LinkedListNode: {"": "Object;_liblib6$_previous?,_liblib6$_next?,_liblib6$_list<,_liblib6$_value",
  get$next: function() {
  ...
  remove$0: function(_) {
    ...
    if (t1 == null)
      return;
    t1.set$_liblib6$_length(t1.get$_liblib6$_length() - 1);
    t1 = this._liblib6$_previous;
    t2 = this._liblib6$_next;
    if (t1 != null)
      t1.set$_liblib6$_next(t2);
    else
      this._liblib6$_list.set$_liblib6$_head(t2);
    t1 = this._liblib6$_next;
    t2 = this._liblib6$_previous;
    if (t1 != null)
      t1.set$_liblib6$_previous(t2);
    else
      this._liblib6$_list.set$_liblib6$_tail(t2);
    this._liblib6$_next = null;
    this._liblib6$_previous = null;
    this._liblib6$_list = null;
  },
  get$remove: function(_liblib5$_receiver) {
    return new $.BoundClosure$i0(this, "remove$0", _liblib5$_receiver);
  }
},
...
LinkedList: {"": "IterableBase;_liblib6$_head?,_liblib6$_tail?,_liblib6$_length@",
  ...
  get$add: function(_liblib5$_receiver) {
    return new $.BoundClosure$i1(this, "add$1", _liblib5$_receiver);
  },
...
LinkedListIterator: {"": "Object;_copy,_liblib6$_list<,_liblib6$_current,_pos",
  get$current: function() {
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (t1 < t3) {
        if (t1 < 0)
          throw $.ioore(t1);
        t1 = !$.$eq(t2[t1].get$_liblib6$_list(), this._liblib6$_list);
      } else
        t1 = false;
    } while (t1);
    t1 = this._pos;
  ...
  LinkedListIterator$1: function(_list) {
    var t1, node, i, i0;
    t1 = $.List_List(this._liblib6$_list._liblib6$_length, $.LinkedListNode);
    t1.$builtinTypeInfo = [$.LinkedListNode];
    this._copy = t1;
    node = this._liblib6$_list._liblib6$_head;
...
DomName: {"": "Object;name>"}}],
["pause", "x_pause.dart", , {
XPause: {"": "WebComponent;_liblib2$_css,__e7,__e10,__e9,__e8<,_liblib2$__t,_liblib2$_time<,name*,text',_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, __binding6, t2;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    ...
    this.__e7 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e9), 1)), 1);
    __binding6 = this._liblib2$__t.contentBind$2(new $.XPause_created_autogenerated_closure(this), false);
    $.addAll$1$ax($.get$nodes$x(this.__e7), [document.createTextNode("\n                "), __binding6, document.createTextNode("\n              ")]);
    this.__e8 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e9), 1)), 3);
    this._liblib2$__t.listen$2($.get$onChange$x(this.__e8), new $.XPause_created_autogenerated_closure0(this));
    this._liblib2$__t.listen$2($.get$onInput$x(this.__e8), new $.XPause_created_autogenerated_closure1(this));
    t1 = this._liblib2$__t;
    t1.oneWayBind$4;
    ...
    t1 = this._liblib2$__t;
    t2 = new $.Collapse(null, null, true, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t2.set$host(t2, this.__e9);
    t1.component$1;
    t1.children.push(new $.ComponentItem(t2));
    t2 = this._liblib2$__t;
    t1 = new $.Accordion(null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t1.set$host(t1, this.__e10);
    t2.component$1;
    t2.children.push(new $.ComponentItem(t1));
...
XPause_created_autogenerated_closure: {"": "Closure;this_0",
  call$0: function() {
    var t1 = this.this_0;
    return t1.timeForHeading$1(t1.get$_liblib2$_time());
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    var t1 = this.this_1;
    $.Primitives_printString("Name of " + $.S(t1.get$_liblib2$_time()) + " changed to: " + $.S($.get$name$x(t1)));
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure1: {"": "Closure;this_2",
  call$1: function($$event) {
    var t1 = this.this_2;
    $.set$name$x(t1, $.get$value$x(t1.get$__e8()));
  },
  $isFunction: true
},
...
dispatch: function() {
  ...
  do {
    for (t1 = $._watchers, t1.get$iterator, t1 = $.LinkedListIterator$(t1), dirty = false; t1.moveNext$0();)
      if (t1._liblib6$_current.compareAndNotify$0())
        dirty = true;
    if (dirty) {
      ++total;
      t1 = total < 10;
...
Accordion: {"": "WebComponent;_liblib0$_css,_liblib0$__t,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
...
Collapse: {"": "WebComponent;_liblib1$_css,_liblib1$__t,_isShown,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
