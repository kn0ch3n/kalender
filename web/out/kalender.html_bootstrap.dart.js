...
$$.Bound_setProperty__CssStyleDeclarationSet = {"": "BoundClosure;_self,_target,_receiver",
  call$3: function(p0, p1, p2) {
    return this._self[this._target](this._receiver, p0, p1, p2);
  },
  call$2: function(propertyName, value) {
    return this.call$3(propertyName, value, null);
  }
};
...
$$.Bound_setProperty_CssStyleDeclaration = {"": "BoundClosure;_self,_target,_receiver",
  call$3: function(p0, p1, p2) {
    return this._self[this._target](this._receiver, p0, p1, p2);
  },
  call$2: function(propertyName, value) {
...
WebComponent_Observable: {"": "WebComponent+Observable;$$_observers@,$$_changes@,hashCode>,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots", $isObservable: true},

XAppointment: {"": "WebComponent_Observable;_css,__e3,__e13,__e14,__e6<,__e5<,__e7,__e9,__e4<,__e8<,__e12<,__t,id>,types<,typeImages<,time@,_liblib11$__$_data,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  created_autogenerated$0: function() {
    ...
    t2 = this.__t;
    t1 = new $.Collapse(null, null, false, false, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
    t1.set$host(t1, this.__e13);
    t2.component$1;
    t2.children.push(new $.ComponentItem(t1));
    t1 = this.__t;
    t2 = new $.Accordion(null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
  ...
  get$_data: function() {
    ...
    return this._liblib11$__$_data;
  },
  set$_data: function(value) {
    ...
    if (t1 != null) {
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "_data", this._liblib11$__$_data, value);
    this._liblib11$__$_data = value;
  },
  get$name: function(_) {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "_data");
    return $.$index$asx(this._liblib11$__$_data, "name");
  },
  ...
  clear$1$save: function(_, save) {
    ...
    if (t2 != null) {
      ...
      t2 = false;
    if (t2)
      $.notifyChange(this, 1, "_data", this._liblib11$__$_data, t1);
    this._liblib11$__$_data = t1;
    if (save)
      this.valueChanged$0();
  },
  clear$0: function($receiver) {
    return this.clear$1$save($receiver, false);
  },
  ...
  isEmpty$0: function(_) {
    ...
    if (t1 != null)
      t1._addRead$3(this, 1, "_data");
    if ($.$index$asx(this._liblib11$__$_data, "name") != null) {
      t1 = $._activeObserver;
      if (t1 != null)
        t1._addRead$3(this, 1, "_data");
      t1 = $.$index$asx(this._liblib11$__$_data, "name");
      if (typeof t1 !== "string")
    ...
    if (t1) {
      ...
      if (t1 != null)
        t1._addRead$3(this, 1, "_data");
      if ($.$index$asx(this._liblib11$__$_data, "number") != null) {
        t1 = $._activeObserver;
        if (t1 != null)
          t1._addRead$3(this, 1, "_data");
        t1 = $.$index$asx(this._liblib11$__$_data, "number");
        if (typeof t1 !== "string")
      ...
      if (t1) {
        ...
        if (t1 != null)
          t1._addRead$3(this, 1, "_data");
        t1 = $.$index$asx(this._liblib11$__$_data, "type");
        if (typeof t1 !== "number")
    ...
    switch (state0) {
      case 0:
        ...
        if (t1 != null)
          t1._addRead$3(this, 1, "_data");
      case 1:
        if (state0 === 1 || state0 === 0 && $.$index$asx(this._liblib11$__$_data, "name") != null)
          switch (state0) {
            case 0:
              t1 = $._activeObserver;
              if (t1 != null)
          ...
          switch (state0) {
            case 0:
              ...
              if (t1 != null)
                t1._addRead$3(this, 1, "_data");
            case 2:
              if (state0 === 2 || state0 === 0 && $.$index$asx(this._liblib11$__$_data, "number") != null)
                switch (state0) {
                  case 0:
                    t1 = $._activeObserver;
                    if (t1 != null)
  ...
  setDirty$0: function() {
    return $.get$XAppointment_dirtyAppointments().push(this);
  },
  toString$0: function(_) {
    return this.timeAndDateForHeading$1(this.time);
  },
  XAppointment$2: function(time, id) {
    this.set$host(this, $._ElementFactoryProvider_createElement_html("<x-appointment id=\"" + id + "\"></x-appointment>"));
    this.time = time;
    this.id = id;
    this.set$_data($.toObservable($.makeLiteralMap(["name", null, "number", null, "type", 0, "color", "#FFFFFF"])));
  },
  $isXAppointment: true,
  static: {
"": "XAppointment___html1,XAppointment___shadowTemplate,XAppointment_dirtyAppointments,XAppointment_connection",
XAppointment$: function(time, id) {
  var t1 = $.$add$ns($.Observable_$_nextHashCode, 1);
  $.Observable_$_nextHashCode = t1;
  t1 = new $.XAppointment(null, null, null, null, null, null, null, null, null, null, null, null, null, ["Frei", "Werkstatt", "Freihalten", "Au\u00dfer Haus", "Einlagen Erstversorgung", "Einlagen Folgeversorgung", "Podologische Sohlen Erstversorgung", "Podologische Sohlen Kontrolle", "Podologische Sohlen Folgeversorgung", "Schuhe Erstversorgung", "Schuhe Folgeversorgung", "Schuhe Probe", "Verk\u00fcrzungsausgleich Erstversorgung", "Verk\u00fcrzungsausgleich Folgeversorgung"], ["img/frei.png", "img/werkstatt.png", "img/freihalten.png", "img/nicht_im_haus.png", "img/ee.png", "img/ef.png", "img/pe.png", "img/pk.png", "img/pf.png", "img/se.png", "img/sf.png", "img/sp.png", "img/ve.png", "img/vf.png"], null, null, null, null, t1, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
  t1.XAppointment$2(time, id);
  return t1;
}}
...
XAppointment_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    ...
    $.set$height$x($.get$style$x(document.querySelector("#termine")), "1000px");
  },
  $isFunction: true
},
...
XAppointment_created_autogenerated_closure17: {"": "Closure;this_18",
  call$1: function($$event) {
    $.clear$1$save$ax(this.this_18, true);
  },
  $isFunction: true
},
...
CustomElement: {"": "Object;_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  get$host: function(_) {
    var t1 = this._liblib12$_host;
    if (t1 == null)
  ...
  get$clientHeight: function(_) {
    return $.get$height$x($.get$client$x(this.get$host(this)));
  },
  get$client: function(_) {
    return $.get$client$x(this.get$host(this));
  },
  get$scrollHeight: function(_) {
    return $.get$scrollHeight$x(this.get$host(this));
  },
  ...
  dispatchEvent$1: function(_, $event) {
    return $.dispatchEvent$1$x(this.get$host(this), $event);
  },
...
_CssStyleDeclarationSet: {"": "Object_CssStyleDeclarationBase;_elementIterable,_elementCssStyleDeclarationSetIterable",
  ...
  get$setProperty: function(_receiver) {
    return new $.Bound_setProperty__CssStyleDeclarationSet(this, "setProperty$3", _receiver);
  },
...
CssStyleDeclarationBase: {"": "Object;",
  ...
  clear$1$save: function($receiver, arg0) {
    return this.get$clear($receiver).call$1$save(arg0);
  },
...
RectBase: {"": "Object;",
  ...
  round$0: function(_) {
    return new $.Rect($.round$0$n(this.get$left(this)), $.round$0$n(this.get$top(this)), $.round$0$n(this.get$width(this)), $.round$0$n(this.get$height(this)));
  }
},
...
CssStyleDeclaration: {"": "Interceptor_CssStyleDeclarationBase;length=",
  ...
  get$setProperty: function(_receiver) {
    return new $.Bound_setProperty_CssStyleDeclaration(this, "setProperty$3", _receiver);
  }
},
...
Element: {"": "Node;id=,innerHtml:innerHTML},title%,className%,clientHeight=,scrollHeight=,style=,tagName=,$$dom_children:children=",
...
FEBlendElement: {"": "StyledElement;height=,x=,y="},

FEColorMatrixElement: {"": "StyledElement;type=,values=,height=,x=,y="},

FEComponentTransferElement: {"": "StyledElement;height=,x=,y="},

FECompositeElement: {"": "StyledElement;height=,x=,y="},

FEConvolveMatrixElement: {"": "StyledElement;height=,x=,y="},

FEDiffuseLightingElement: {"": "StyledElement;height=,x=,y="},

FEDisplacementMapElement: {"": "StyledElement;height=,x=,y="},

FEFloodElement: {"": "StyledElement;height=,x=,y="},

FEGaussianBlurElement: {"": "StyledElement;height=,x=,y="},

FEImageElement: {"": "StyledElement;height=,x=,y="},

FEMergeElement: {"": "StyledElement;height=,x=,y="},

FEMorphologyElement: {"": "StyledElement;height=,x=,y="},

FEOffsetElement: {"": "StyledElement;height=,x=,y="},

FEPointLightElement: {"": "SvgElement;x=,y="},

FESpecularLightingElement: {"": "StyledElement;height=,x=,y="},

FESpotLightElement: {"": "SvgElement;x=,y="},

FETileElement: {"": "StyledElement;height=,x=,y="},

FETurbulenceElement: {"": "StyledElement;type=,height=,x=,y="},

FilterElement: {"": "StyledElement;height=,x=,y="},

ForeignObjectElement: {"": "StyledElement;height=,x=,y="},

ImageElement0: {"": "StyledElement;height=,x=,y="},

MaskElement: {"": "StyledElement;height=,x=,y="},

PatternElement: {"": "StyledElement;height=,x=,y="},

RectElement: {"": "StyledElement;height=,x=,y="},
...
min: function(a, b) {
  ...
  if (typeof b === "number") {
    if (typeof a === "number")
      if (a === 0)
        return (a + b) * a * b;
    if (a === 0 && $.JSDouble_methods.get$isNegative(b) || isNaN(b))
      return b;
    return a;
  }
  return a;
...
ShowHide__populateState: function(element) {
  ...
  inferredState = $.$eq(computedDisplay, "none") ? $.ShowHideState_hidden : $.ShowHideState_shown;
  t1 = $.get$ShowHide__values();
...
ShowHide__requestShow: function(element, desiredDuration, effect, effectTiming) {
  var t1, values, fractionComplete, durationMS, t2, t3, t4, value;
  t1 = $.get$ShowHide__values();
...
ShowHide__requestHide: function(element, desiredDuration, effect, effectTiming) {
  var t1, fractionComplete, durationMS, t2, t3, t4, value;
  t1 = $.get$ShowHide__values();
...
ShowHide__getShowDisplayValue: function(element) {
  ...
  t1 = $.get$ShowHide__values();
  values = t1.$index(t1, element);
  if ($.$eq(values.get$initialComputedDisplay(), "none")) {
    t1 = $.get$ShowHide__defaultDisplays();
    return t1.$index(t1, $.get$tagName$x(element));
  } else if ($.$eq(values.get$initialLocalDisplay(), "") || $.$eq(values.get$initialLocalDisplay(), "inherit"))
...
Tools_getDefaultDisplay: function(nodeName) {
  ...
  if (storedValue != null)
    ...
    if (t1.$eq(defaultDisplay, "none") || t1.$eq(defaultDisplay, ""))
...
Css3TransitionEffect: {"": "ShowHideEffect;",
  ...
  clearAnimation$1: function(element) {
    ...
    style = $.get$style$x(element);
    t1 = $.getInterceptor$x(style);
  ...
  _startAnimation$5: function(doingShow, element, desiredDuration, timing, fractionComplete) {
    ...
    $.JSArray_methods.addAll$1(localPropsToKeep, t2.get$keys());
    localValues = $.Css3TransitionEffect__recordProperties(element, localPropsToKeep);
    t3 = $.getInterceptor$x(element);
    $.forEach$1$ax(t2, $.get$setProperty$x(t3.get$style(element)));
    ...
    if (doingShow) {
      if (typeof fractionComplete !== "number")
        throw $.iae(fractionComplete);
      animationFractionLeft = 1 - fractionComplete;
    } else
      animationFractionLeft = fractionComplete;
    actualDuration = $.round$0$n($.$mul$n(desiredDuration, animationFractionLeft));
    $.setProperty$2$x(t3.get$style(element), t1, startValue);
    $._css3TransitionEffectValues_delayStart(element, localValues, new $.Css3TransitionEffect__startAnimation_closure(this, element, timing, endValue, actualDuration));
...
ShrinkEffect: {"": "Css3TransitionEffect;_property,_animatingOverrides",
  computePropertyValue$2: function(fractionComplete, element) {
    return $.$le$n(fractionComplete, 0) ? "0" : $.S($.$mul$n($.get$scrollHeight$x(element), fractionComplete)) + "px";
  },
  computeFractionComplete$1: function(element) {
    var t1, t2;
    t1 = $.getInterceptor$x(element);
    if ($.$gt$n(t1.get$scrollHeight(element), 0)) {
...
main: function() {
  ...
  $.XSummary_connection = $.kalenderConnection;
  $.selectedDate = $.toDateString($.DateTime$_now());
  $.setupUI();
  t1 = document.body;
  t1.get$onMouseWheel;
  t1 = $._CustomEventStreamProvider__determineMouseWheelEventType.forTarget$1(t1);
  t2 = new $._EventStreamSubscription(0, t1._liblib3$_target, t1._eventType, new $.main_closure0(), t1._useCapture);
...
setupUI: function() {
  var year, month, i, t1, t2, column, t3, h, t4, t5, t6, m, id, t, t7, truncated, x, obj, lifecycleCaller, t8, t9;
  ...
  for (i = 1; i <= $.maxDays; ++i) {
    t1 = i > 9;
    t2 = "#termine_" + (t1 ? $.JSInt_methods.toString$0(i) : $.JSString_methods.$add("0", $.JSInt_methods.toString$0(i)));
    column = document.querySelector(t2);
    $.get$appointmentColumns().push(column);
    if (column != null) {
      t2 = $.get$xsummaries();
      t3 = new $.DateTime($.Primitives_valueFromDecomposedDate(year, month, i, 0, 0, 0, 0, false), false);
      if (t3.date === void 0)
        t3.date = new Date(t3.millisecondsSinceEpoch);
      t3.date;
      t2.push($.summaryCreator(t3, column));
      for (t2 = $.getInterceptor$x(column), h = 8; h <= 17; ++h)
        for (t3 = h === 13, t4 = h === 12, t5 = !t4, t6 = (h - 8) * 3, m = 0; m <= 40; m += 20) {
          id = t1 ? $.JSInt_methods.toString$0(i) : $.JSString_methods.$add("0", $.JSInt_methods.toString$0(i));
...
pauseCreator: function(time, $parent) {
  ...
  ++t1;
  $.Observable_$_nextHashCode = t1;
  obj = new $.XPause(null, null, null, null, null, null, null, null, null, null, null, t1, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
...
summaryCreator: function(time, $parent) {
  ...
  ++t1;
  $.Observable_$_nextHashCode = t1;
  obj = new $.XSummary(null, null, null, null, null, null, null, t1, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
...
dateChanged: function() {
  ...
  if ($.$ge$n($.get$length$asx($.selectedDate), 7)) {
    document.body.scrollLeft = $.$add$ns($.$mul$n($.$sub$n($.Primitives_parseInt($.substring$2$s($.selectedDate, 8, 10), null, null), 1), $.columnWidth), 66);
...
updateView: function() {
  ...
  for (t1 = $.get$xappointments(), t1 = t1.get$values(t1), t2 = t1._iterable, t2 = t2.get$iterator(t2), t2 = new $.MappedIterator(null, t2, t1._f), $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "MappedIterable", 0), $.getRuntimeTypeArgument(t1, "MappedIterable", 1)]); t2.moveNext$0();) {
    x = t2._liblib$_current;
...
updateNextFreeSpots: function() {
  var nextFreeSpots, t1, t2, candidates;
  ...
  t1 = $.get$xappointments();
  t1 = t1.get$values(t1);
  t2 = new $.WhereIterable(t1, new $.updateNextFreeSpots_closure());
  $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "IterableBase", 0)]);
  candidates = $.List_List$from(t2, true, $.getRuntimeTypeArgument(t2, "IterableBase", 0));
  $.IterableMixinWorkaround_sortList(candidates, new $.updateNextFreeSpots_closure0());
  t1 = $.SubListIterable$(candidates, 0, 30, null);
  t1.forEach$1(t1, new $.updateNextFreeSpots_closure1(nextFreeSpots));
},
...
extend: function(source) {
  ...
  t1 = {};
  $.Primitives_printString("extend " + $.S(source));
  t1.nextId_0 = $.getNextId(source.id);
  $.Primitives_printString("nextId: " + t1.nextId_0);
  t1.doAgain_1 = true;
  for (; t1.doAgain_1;) {
    t1.doAgain_1 = false;
    if (t1.nextId_0 != null) {
      t2 = $.get$xappointments();
      t2 = t2.get$values(t2);
      $arguments = $.substitute(t2.$asIterableBase, $.getRuntimeTypeInfo(t2));
      t3 = $arguments == null ? null : $arguments[0];
      t2 = new $.WhereIterable(t2, new $.extend_closure(t1));
...
updateNextFreeSpots_closure0: {"": "Closure;",
  call$2: function(a, b) {
    var t1, t2;
    if ($.$eq(a.get$time(), b))
      return 0;
      ...
      t2 = b.get$time();
      t1.isAfter$1;
      if ($.$gt$n(t1.millisecondsSinceEpoch, t2.millisecondsSinceEpoch))
        return 1;
      else
        return -1;
    }
...
updateNextFreeSpots_closure1: {"": "Closure;nextFreeSpots_0",
  call$1: function(a) {
...
KalenderConnection: {"": "Object;webSocket,url",
  ...
  _receivedEncodedMessage$2$updateNextFreeSpots: function(encodedMessage, updateNextFreeSpots) {
    ...
    if (typeof message === "object" && message !== null && !!$.getInterceptor(message).$isMap && message.containsKey$1("mtype") === true) {
      ...
      if ($.$eq(t1.$index(message, "mtype"), "month")) {
        $.Primitives_printString("Received a month message: " + $.S(message));
        ...
        time = $.DateTime_parse(t1.$index(message, "time"));
        t2 = $.get$xappointments();
        if (t2.$index(t2, time) == null) {
          t2 = $.get$xappointments();
          t3 = $.get$xappointments();
          t3 = t3.$index(t3, $.DateTime$_internal($.startingYear, $.startingMonth, $.Primitives_getDay(time), $.Primitives_getHours(time), $.Primitives_getMinutes(time), 0, 0, false));
          t4 = $.getInterceptor$x(t3);
          t4.set$name(t3, $.$index$asx(t1.$index(message, "data"), "name"));
          t3.set$number($.$index$asx(t1.$index(message, "data"), "number"));
          t4.set$type(t3, $.$index$asx(t1.$index(message, "data"), "type"));
          t4.set$color(t3, $.$index$asx(t1.$index(message, "data"), "color"));
          t3.setDirty$0();
          t2.$indexSet(t2, time, t3);
        } else {
          t2 = $.get$xappointments();
          t2 = t2.$index(t2, time);
          t3 = $.getInterceptor$x(t2);
          t3.set$name(t2, $.$index$asx(t1.$index(message, "data"), "name"));
          t2.set$number($.$index$asx(t1.$index(message, "data"), "number"));
          t3.set$type(t2, $.$index$asx(t1.$index(message, "data"), "type"));
          t3.set$color(t2, $.$index$asx(t1.$index(message, "data"), "color"));
          t2.setDirty$0();
        }
        if (updateNextFreeSpots)
          $.updateNextFreeSpots();
      } else if ($.$eq(t1.$index(message, "mtype"), "pause")) {
        t1 = new $.WhereIterable($.get$xpauses(), new $.KalenderConnection__receivedEncodedMessage_closure0(message));
        $.setRuntimeTypeInfo(t1, [null]);
        t2 = new $.HashSet(0, null, null, null, null);
        $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "IterableBase", 0)]);
        t2.addAll$1(t2, t1);
        ...
        t1 = new $.WhereIterable($.get$xsummaries(), new $.KalenderConnection__receivedEncodedMessage_closure2(message));
        $.setRuntimeTypeInfo(t1, [null]);
        t2 = new $.HashSet(0, null, null, null, null);
        $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "IterableBase", 0)]);
        t2.addAll$1(t2, t1);
  ...
  _init$1: function(retrySeconds) {
    ...
    t3 = new $._EventStreamSubscription(0, t2._liblib3$_target, t2._eventType, new $.KalenderConnection__init_closure(this), t2._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    t3 = this.webSocket;
    t3.get$onClose;
    t3 = $.EventStreamProvider_close.forTarget$1(t3);
    t2 = new $._EventStreamSubscription(0, t3._liblib3$_target, t3._eventType, new $.KalenderConnection__init_closure0(t1), t3._useCapture);
    $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = this.webSocket;
    t2.get$onError;
    t2 = $.EventStreamProvider_error.forTarget$1(t2);
    t1 = new $._EventStreamSubscription(0, t2._liblib3$_target, t2._eventType, new $.KalenderConnection__init_closure1(t1), t2._useCapture);
    $.setRuntimeTypeInfo(t1, [$.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = this.webSocket;
    t1.get$onMessage;
    t1 = $.EventStreamProvider_message.forTarget$1(t1);
    t2 = new $._EventStreamSubscription(0, t1._liblib3$_target, t1._eventType, new $.KalenderConnection__init_closure2(this), t1._useCapture);
    $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  _init$0: function() {
...
Unstable: {"": "Object;"}}],
["pause", "x_pause.dart", , {
WebComponent_Observable0: {"": "WebComponent+Observable;$$_observers@,$$_changes@,hashCode>,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots", $isObservable: true},

XPause: {"": "WebComponent_Observable0;_liblib15$_css,__e16,__e19,__e20,__e17<,_liblib15$__t,__e18<,time@,__$_data,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  created_autogenerated$0: function() {
    ...
    t1 = this._liblib15$__t;
    t2 = new $.Collapse(null, null, false, false, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
    t2.set$host(t2, this.__e19);
    t1.component$1;
    t1.children.push(new $.ComponentItem(t2));
    t2 = this._liblib15$__t;
    t1 = new $.Accordion(null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])), null, null, $.makeLiteralMap([]));
...
WebComponent_Observable1: {"": "WebComponent+Observable;$$_observers@,$$_changes@,hashCode>,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots", $isObservable: true},

XSummary: {"": "WebComponent_Observable1;_liblib14$_css,_liblib14$__t,__e21<,time@,_liblib14$__$_data,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  created_autogenerated$0: function() {
    var __root, t1, t2;
    __root = this.createShadowRoot$1(this, "x-summary");
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap(["x-summary", "[is=\"x-summary\"]"]));
    this._liblib14$_css = this._mapper;
    this._liblib14$__t = new $.Template(__root, [], []);
    t1 = $.getInterceptor$x(__root);
    $.add$1$ax(t1.get$nodes(__root), $.clone$1$x($.get$XSummary___shadowTemplate(), true));
    this.__e21 = $.$index$asx(t1.get$nodes(__root), 1);
    this._liblib14$__t.listen$2($.get$onChange$x(this.__e21), new $.XSummary_created_autogenerated_closure(this));
    this._liblib14$__t.listen$2($.get$onInput$x(this.__e21), new $.XSummary_created_autogenerated_closure0(this));
    t1 = this._liblib14$__t;
    t1.oneWayBind$4;
    t1 = t1.children;
    if ($.verboseDebugMessages) {
      $.get$readCurrentStackTrace();
      ...
      t2 = false;
    t2 = t2 ? $.get$readCurrentStackTrace().call$0() : null;
    t1.push(new $.DomPropertyBinding(new $.XSummary_created_autogenerated_closure1(this), false, new $.XSummary_created_autogenerated_closure2(this), false, t2, null));
  ...
  valueChanged$0: function() {
    ...
    var t1 = $.XSummary_connection;
    t1.send$3(t1, "summary", this.time, this.get$_liblib14$_data());
  },
  $isXSummary: true,
  static: {
"": "XSummary___shadowTemplate,XSummary_dirtySummaries,XSummary_connection",
}

},

XSummary_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function($$event) {
    this.this_0.valueChanged$0();
  },
  $isFunction: true
},

XSummary_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    var t1, t2;
    t1 = this.this_1;
    t2 = $.get$value$x(t1.get$__e21());
    $.$indexSet$ax(t1.get$_liblib14$_data(), "text", t2);
  },
  $isFunction: true
},

XSummary_created_autogenerated_closure2: {"": "Closure;this_2",
  call$0: function() {
    return $.$index$asx(this.this_2.get$_liblib14$_data(), "text");
  },
  $isFunction: true,
  $is_void_: true
},

XSummary_created_autogenerated_closure1: {"": "Closure;this_3",
  call$1: function(e) {
    var t1 = this.this_3;
    if (!$.$eq($.get$value$x(t1.get$__e21()), e))
      $.set$value$x(t1.get$__e21(), e);
  },
  $isFunction: true
}}],
...
Accordion: {"": "WebComponent;_liblib18$_css,_liblib18$__t,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  created_autogenerated$0: function() {
  ...
  created$0: function() {
    ...
    $.setRuntimeTypeInfo(t1, [null]);
    t2 = this.get$_onOpen();
    t2 = new $._EventStreamSubscription(0, t1._liblib3$_target, t1._eventType, t2, t1._useCapture);
    $.setRuntimeTypeInfo(t2, [$.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  ...
  _onShowHideToggle$1: function(shc) {
    var t1;
    if (shc.get$isShown()) {
      t1 = $.map$1$ax($.queryAll$1$x(this.get$host(this), "[is=x-accordion] > [is=x-collapse]"), new $.Accordion__onShowHideToggle_closure());
...
Collapse: {"": "WebComponent;_liblib19$_css,_liblib19$__t,_isShown,_insertedCalled,_host,_shadowRoots,_generatedRoots,_mapper,_liblib12$_host,_liblib12$_shadowRoots,_liblib12$_generatedRoots",
  created_autogenerated$0: function() {
  ...
  set$isShown: function(value) {
    ...
    if (value !== this._isShown) {
      this._isShown = value;
      this._updateElements$1(!this._insertedCalled);
      t1 = $.Event_Event$eventType("Event", "toggle", true, true);
      $.dispatchEvent$1$x(this.get$host(this), t1);
    }
  },
  hide$0: function() {
  ...
  _updateElements$1: function(skipAnimation) {
    ...
    collapseDiv = $.query$1$x(this.get$host(this), ".collapse-body-x");
    if (collapseDiv != null) {
...
$.XAppointment.$isXAppointment = true;
...
$.C__NoOpShowHideEffect = new $._NoOpShowHideEffect();
...
$.clear$1$save$ax = function(receiver, a0) {
  return $.getInterceptor$ax(receiver).clear$1$save(receiver, a0);
};
...
$.get$scrollHeight$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$scrollHeight(receiver);
};
$.get$selectedIndex$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$selectedIndex(receiver);
};
$.get$setProperty$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$setProperty(receiver);
};
...
Isolate.$lazy($, "xappointments", "xappointments", "get$xappointments", function() {
  var t1 = new $.HashMap(0, null, null, null, null);
  $.setRuntimeTypeInfo(t1, [$.DateTime, $.XAppointment]);
  return t1;
});
...
Isolate.$lazy($, "__shadowTemplate", "XSummary___shadowTemplate", "get$XSummary___shadowTemplate", function() {
  return $.DocumentFragment_DocumentFragment$html("        <textarea rows=\"1\"></textarea>\n      ");
});
...
Isolate.$lazy($, "_effect", "Collapse__effect", "get$Collapse__effect", function() {
  ...
  t2.addAll$1(t2, t1);
  t2 = new $.ShrinkEffect("max-height", t2);
  t2.Css3TransitionEffect$2("max-height", t1);
  return t2;
});
// Native classes
$.defineNativeMethods("ArrayBuffer|FileError|MediaError|MediaKeyError|Navigator|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString", $.Interceptor);
