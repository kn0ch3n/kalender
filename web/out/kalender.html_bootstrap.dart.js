...
// Bound closures
$$.BoundClosure$i0 = {"": "BoundClosure;_self,_liblib8$_target,_liblib8$_receiver",
  call$0: function() {
    return this._self[this._liblib8$_target](this._liblib8$_receiver);
  }
};

$$.BoundClosure$1 = {"": "BoundClosure;_self,_liblib8$_target,_liblib8$_receiver",
  call$1: function(p0) {
    return this._self[this._liblib8$_target](p0);
  }
};

$$.BoundClosure$0 = {"": "BoundClosure;_self,_liblib8$_target,_liblib8$_receiver",
  call$0: function() {
    return this._self[this._liblib8$_target]();
  }
};

$$.BoundClosure$i1 = {"": "BoundClosure;_self,_liblib8$_target,_liblib8$_receiver",
  call$1: function(p0) {
    return this._self[this._liblib8$_target](this._liblib8$_receiver, p0);
  }
};

$$.BoundClosure$2 = {"": "BoundClosure;_self,_liblib8$_target,_liblib8$_receiver",
  call$2: function(p0, p1) {
    return this._self[this._liblib8$_target](p0, p1);
  }
};
...
_EventLoop: {"": "Object;events,activeTimerCount",
  dequeue$0: function() {
    var t1 = this.events;
    if (t1._liblib0$_head === t1._liblib0$_tail)
      return;
...
BoundClosure: {"": "Closure;_self,_liblib8$_target,_liblib8$_receiver",
  $eq: function(_, other) {
    if (other == null)
      return false;
    if (this === other)
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isBoundClosure)
      return false;
    return this._self === other._self && this._liblib8$_target === other._liblib8$_target && this._liblib8$_receiver === other._liblib8$_receiver;
  },
  get$hashCode: function(_) {
    return $.get$hashCode$(this._self) + $.get$hashCode$(this._liblib8$_target) + $.get$hashCode$(this._liblib8$_receiver) & 0x3ffffff;
  },
  $isBoundClosure: true
},
...
XAppointment: {"": "WebComponent_Observable;_css,__e2,__e10,__e9,__e4<,__e3<,__e5<,__e8<,__t,id>,types<,typeImages<,time@,__$_data<,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper",
...
XAppointment_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    ...
    t1 = this.this_1;
    $.get$XAppointment_dirtyAppointments().push(t1);
    ...
    t2 = $.statusArea;
    t1.timeAndDateForHeading$1(t1.get$time());
    t3 = $._activeObserver;
    if (t3 != null)
...
XAppointment$: function(time, id) {
  ...
  t1 = new $.XAppointment(null, null, null, null, null, null, null, null, null, null, ["Frei", "Werkstatt", "Nicht im Haus", "Einlagen", "Einlagen Folge"], ["img/frei.png", "img/werkstatt.png", "img/nicht_im_haus.png", "img/einlagen.png", "img/einlagen_folge.png"], null, null, null, null, t1, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
...
Size: {"": "Object;width>,height>",
  ...
  get$isEmpty: function(_liblib8$_receiver) {
    return new $.BoundClosure$i0(this, "isEmpty$0", _liblib8$_receiver);
  },
...
WhereIterator: {"": "Iterator;_liblib1$_iterator,_f",
  _f$1: function(arg0) {
    return this._f.call$1(arg0);
  },
  moveNext$0: function() {
    for (var t1 = this._liblib1$_iterator; t1.moveNext$0() === true;)
...
TakeIterator: {"": "Iterator;_liblib1$_iterator,_liblib1$_remaining",
  moveNext$0: function() {
    this._liblib1$_remaining = $.$sub$n(this._liblib1$_remaining, 1);
    if ($.$ge$n(this._liblib1$_remaining, 0))
      return this._liblib1$_iterator.moveNext$0();
    this._liblib1$_remaining = -1;
    return false;
  },
  get$current: function() {
    if ($.$lt$n(this._liblib1$_remaining, 0))
      return;
    return this._liblib1$_iterator.get$current();
  },
  $asIterator: null
...
HashMapKeyIterable: {"": "IterableBase;_liblib0$_map",
  ...
  get$isEmpty: function(_) {
    return this._liblib0$_map._liblib0$_length === 0;
  },
  get$iterator: function(_) {
  ...
  contains$1: function(_, element) {
    return this._liblib0$_map.containsKey$1(element);
  },
  forEach$1: function(_, f) {
...
HashMapKeyIterator: {"": "Object;_liblib0$_map,_keys,_liblib0$_offset,_liblib0$_current",
  get$current: function() {
...
ListQueue: {"": "IterableBase;_table,_liblib0$_head,_liblib0$_tail,_modificationCount",
  get$iterator: function(_) {
    return new $._ListQueueIterator(this, this._liblib0$_tail, this._modificationCount, this._liblib0$_head, null);
  },
  forEach$1: function(_, action) {
  ...
  get$length: function(_) {
    var t1, t2;
    t1 = $.$sub$n(this._liblib0$_tail, this._liblib0$_head);
    t2 = this._table;
    if (typeof t1 !== "number")
      throw t1.$and();
  ...
  elementAt$1: function(_, index) {
    ...
    if (!t1.$lt(index, 0)) {
      t2 = $.$sub$n(this._liblib0$_tail, this._liblib0$_head);
      t3 = this._table;
      if (typeof t2 !== "number")
        throw t2.$and();
  ...
  removeLast$0: function(_) {
    ...
    if (this._liblib0$_head === this._liblib0$_tail)
      throw $.wrapException(new $.StateError("No elements"));
    this._modificationCount = this._modificationCount + 1;
    t1 = $.$sub$n(this._liblib0$_tail, 1);
    t2 = this._table;
    if (typeof t1 !== "number")
      throw t1.$and();
...
_SplayTreeValueIterable: {"": "IterableBase;_liblib0$_map",
  get$length: function(_) {
    return this._liblib0$_map._count;
  },
  get$isEmpty: function(_) {
    return this._liblib0$_map._count === 0;
  },
  get$iterator: function(_) {
...
Stopwatch: {"": "Object;_liblib18$_start,_stop",
  start$0: function(_) {
    var t1, t2, t3;
    t1 = this._liblib18$_start == null;
    if (!t1 && this._stop == null)
      return;
    if (t1)
      this._liblib18$_start = $.Primitives_numMicroseconds();
    else {
      t1 = $.Primitives_numMicroseconds();
      t2 = this._stop;
      t3 = this._liblib18$_start;
      if (t2 == null)
        throw t2.$sub();
      if (t3 == null)
        throw $.iae(t3);
      this._liblib18$_start = t1 - (t2 - t3);
      this._stop = null;
    }
  },
  get$elapsedTicks: function() {
    var t1, t2;
    t1 = this._liblib18$_start;
    if (t1 == null)
      return 0;
    t2 = this._stop;
    if (t2 == null) {
      t1 = $.Primitives_numMicroseconds();
      t2 = this._liblib18$_start;
      if (t2 == null)
        throw $.iae(t2);
      t2 = t1 - t2;
      t1 = t2;
  ...
  get$elapsedMilliseconds: function() {
    return $.JSNumber_methods.$tdiv(this.get$elapsedTicks() * 1000, 1000000);
  }
},
...
Uri: {"": "Object;_liblib18$_port,_path,scheme,userInfo,host,query,fragment,_pathSegments,_queryParameters",
  ...
  _writeAuthority$1: function(ss) {
    ...
    str = typeof str === "string" ? str : $.S(str);
    ss._contents = ss._contents + str;
    if (!$.$eq(this._liblib18$_port, 0)) {
      ss._contents = ss._contents + ":";
      str = $.toString$0(this._liblib18$_port);
      str = typeof str === "string" ? str : $.S(str);
      ss._contents = ss._contents + str;
    }
  },
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isUri)
      return false;
    return $.$eq(this.scheme, other.scheme) && $.$eq(this.userInfo, other.userInfo) && $.$eq(this.host, other.host) && $.$eq(this._liblib18$_port, other._liblib18$_port) && $.$eq(this._path, other._path) && $.$eq(this.query, other.query) && $.$eq(this.fragment, other.fragment);
  },
  get$hashCode: function(_) {
    var t1 = new $.Uri_hashCode_combine();
    return t1.call$2(this.scheme, t1.call$2(this.userInfo, t1.call$2(this.host, t1.call$2(this._liblib18$_port, t1.call$2(this._path, t1.call$2(this.query, t1.call$2(this.fragment, 1)))))));
  },
  Uri$9$fragment$host$path$pathSegments$port$query$queryParameters$scheme$userInfo: function(fragment, host, path, pathSegments, port, query, queryParameters, scheme, userInfo) {
    ...
    if (t1.$eq(scheme, "http") && $.$eq(port, 80))
      this._liblib18$_port = 0;
    else if (t1.$eq(scheme, "https") && $.$eq(port, 443))
      this._liblib18$_port = 0;
    else
      this._liblib18$_port = port;
...
Duration$: function(days, hours, microseconds, milliseconds, minutes, seconds) {
  if (typeof milliseconds !== "number")
    return $.Duration$$bailout(1, days, hours, microseconds, milliseconds, minutes, seconds);
...
Duration$$bailout: function(state0, days, hours, microseconds, milliseconds, minutes, seconds) {
  var t1, t2;
...
_WrappedIterator: {"": "Object;_iterator",
  ...
  get$current: function() {
    return this._iterator._liblib$_current;
  }
},
...
["dart.utf", "dart:utf", , {
_ListRange: {"": "IterableBase;_liblib12$_source,_offset,_liblib12$_length",
  get$iterator: function(_) {
    var t1, t2;
    t1 = this._offset;
    ...
    if (typeof t2 !== "number")
      throw $.iae(t2);
    return new $._ListRangeIteratorImpl(this._liblib12$_source, t1 - 1, t1 + t2);
  },
  get$length: function(_) {
  ...
  _ListRange$3: function(source, offset, $length) {
    var t1, t2, t3;
    t1 = this._offset;
    if (t1 < 0 || t1 > this._liblib12$_source.length)
    ...
    if (t2 == null)
      throw t2.$add();
    t1 = t2 + t1;
    if (t1 > this._liblib12$_source.length)
      throw $.wrapException(new $.RangeError("value " + t1));
  },
  $asIterable: function() { return [null]; }
},

_ListRangeIteratorImpl: {"": "Object;_liblib12$_source,_offset,_end",
  get$current: function() {
    var t1, t2;
...
codepointsToUtf8: function(codepoints, offset, $length) {
  ...
  for (t1 = new $._ListRangeIteratorImpl(t1, t2, t3), t2 = t1._end, t3 = t1._liblib12$_source, t4 = encoded.length, insertAt = 0; t5 = t1._offset + 1, t1._offset = t5, t5 < t2;) {
    t5 = t1._offset;
    if (t5 !== (t5 | 0))
...
KalenderConnection: {"": "Object;webSocket<,url",
  ...
  _receivedEncodedMessage$1: function(encodedMessage) {
    var message, t1, $arguments, arguments0, t2, t3;
    ...
    if (typeof message === "object" && message !== null && (message.constructor === Array || !!$.getInterceptor(message).$isList)) {
      $.Primitives_printString("Received a list (a whole month): " + $.S(message));
      $.forEach$1$ax(message, new $.KalenderConnection__receivedEncodedMessage_closure());
    }
    if (typeof message === "object" && message !== null && !!$.getInterceptor(message).$isMap)
      if (message.$index(message, "data").containsKey$1("number") === true) {
        $.Primitives_printString("Received a map (an appointment): " + $.S(message));
        if ($.substring$2$s(message.$index(message, "time"), 0, 7) === $.yearAndMonth) {
          ...
          $.setRuntimeTypeInfo(t3, [t2]);
          t3.addAll$1(t3, t1);
          t3.forEach$1(t3, new $.KalenderConnection__receivedEncodedMessage_closure1(message));
        }
      } else if (message.$index(message, "data").containsKey$1("text") === true) {
        $.Primitives_printString("Received a map (a pause): " + $.S(message));
        if ($.substring$2$s(message.$index(message, "time"), 0, 7) === $.yearAndMonth) {
          ...
          $.setRuntimeTypeInfo(t3, [t2]);
          t3.addAll$1(t3, t1);
          t3.forEach$1(t3, new $.KalenderConnection__receivedEncodedMessage_closure3(message));
        }
      }
  },
  _init$1: function(retrySeconds) {
    ...
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ...
      $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
    t3 = $arguments == null ? null : $arguments[0];
    t2 = new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.KalenderConnection__init_closure(this), t2._useCapture);
    ...
    t2 = this.webSocket;
    t2.get$onClose;
    t2 = $.EventStreamProvider_close.forTarget$1(t2);
    $arguments = t2.$as_EventStream;
    arguments0 = $.getRuntimeTypeInfo(t2);
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ;
...
KalenderConnection__receivedEncodedMessage_closure: {"": "Closure;",
  call$1: function(a) {
    var t1, $arguments, arguments0, t2, t3;
    t1 = $.getInterceptor$asx(a);
    if (t1.$index(a, "data").containsKey$1("number") === true) {
      t1 = new $.WhereIterable($.get$xappointments(), new $.KalenderConnection__receivedEncodedMessage__closure(a));
      t1.$builtinTypeInfo = [null];
      $arguments = t1.$asIterableBase;
      arguments0 = $.getRuntimeTypeInfo(t1);
      if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ...
      $.setRuntimeTypeInfo(t3, [t2]);
      t3.addAll$1(t3, t1);
      t3.forEach$1(t3, new $.KalenderConnection__receivedEncodedMessage__closure0(a));
    } else if (t1.$index(a, "data").containsKey$1("text") === true) {
      t1 = new $.WhereIterable($.get$xpauses(), new $.KalenderConnection__receivedEncodedMessage__closure1(a));
      t1.$builtinTypeInfo = [null];
      $arguments = t1.$asIterableBase;
      arguments0 = $.getRuntimeTypeInfo(t1);
      if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ...
      $.setRuntimeTypeInfo(t3, [t2]);
      t3.addAll$1(t3, t1);
      t3.forEach$1(t3, new $.KalenderConnection__receivedEncodedMessage__closure2(a));
    }
  },
  $isFunction: true
},

KalenderConnection__receivedEncodedMessage__closure: {"": "Closure;a_0",
  call$1: function(x) {
    return $.$eq(x.get$time(), $.DateTime_parse($.$index$asx(this.a_0, "time")));
  },
  $isFunction: true
},

KalenderConnection__receivedEncodedMessage__closure0: {"": "Closure;a_1",
  call$1: function(x) {
    var t1, t2, t3;
    t1 = this.a_1;
    t2 = $.getInterceptor$asx(t1);
    t3 = $.getInterceptor$x(x);
    t3.set$name(x, $.$index$asx(t2.$index(t1, "data"), "name"));
    x.set$number($.$index$asx(t2.$index(t1, "data"), "number"));
    t3.set$type(x, $.$index$asx(t2.$index(t1, "data"), "type"));
    $.get$XAppointment_dirtyAppointments().push(x);
  },
  $isFunction: true
},

KalenderConnection__receivedEncodedMessage__closure1: {"": "Closure;a_2",
  call$1: function(x) {
    return $.$eq(x.get$time(), $.DateTime_parse($.$index$asx(this.a_2, "time")));
  },
  $isFunction: true
},

KalenderConnection__receivedEncodedMessage__closure2: {"": "Closure;a_3",
  call$1: function(x) {
    var t1, t2, t3;
    t1 = this.a_3;
    t2 = $.getInterceptor$asx(t1);
    t3 = $.getInterceptor$x(x);
    t3.set$name(x, $.$index$asx(t2.$index(t1, "data"), "name"));
    t3.set$text(x, $.$index$asx(t2.$index(t1, "data"), "text"));
    $.get$XPause_dirtyPauses().push(x);
  },
  $isFunction: true
},

KalenderConnection__receivedEncodedMessage_closure0: {"": "Closure;message_4",
  call$1: function(x) {
...
KalenderConnection__receivedEncodedMessage_closure1: {"": "Closure;message_5",
  call$1: function(x) {
    var t1, t2;
    t1 = this.message_5;
...
KalenderConnection__receivedEncodedMessage_closure2: {"": "Closure;message_6",
  call$1: function(x) {
...
KalenderConnection__receivedEncodedMessage_closure3: {"": "Closure;message_7",
  call$1: function(x) {
    var t1, t2;
    t1 = this.message_7;
    t2 = $.getInterceptor$x(x);
...
KalenderConnection__init_closure: {"": "Closure;this_5",
  call$1: function(e) {
    ...
    t1 = $.makeLiteralMap(["time", $.yearAndMonth]);
    output = new $.StringBuffer("");
    output.StringBuffer$1("");
    new $._JsonStringifier(output, []).stringifyValue$1(t1);
    encoded = output._contents;
    t1 = this.this_5.get$webSocket();
    if (t1 != null && t1.readyState === 1)
      t1.send(encoded);
    else
      $.Primitives_printString("WebSocket not connected, message " + encoded + " not sent");
...
setupUI: function() {
  var year, month, i, t1, column, h, t2, t3, t4, t5, m, t, id, t6, truncated, x;
  ...
  for (i = 1; i <= $.maxDays; ++i) {
    $.Primitives_printString("Timing 3: " + $.S($.sw.get$elapsedMilliseconds()) + " ms");
    ...
    if (column != null)
      for (t1 = i > 9, h = 8; h <= 17; ++h)
        for (t2 = h === 13, t3 = h === 12, t4 = !t3, t5 = (h - 8) * 3, m = 0; m <= 40; m += 20) {
          ...
          $.get$xappointments().push($.appointmentCreator(t, id, column));
        }
  }
  $.dateChanged();
},

appointmentCreator: function(time, id, $parent) {
  var obj, lifecycleCaller, t1, t2;
  obj = $.XAppointment$(time, id);
...
pauseCreator: function(time, $parent) {
  ...
  if (t2 != null && t2.get$head(t2) != null)
    $.notifyChange(obj, 1, "_data", obj._liblib15$__$_data, t1);
  obj._liblib15$__$_data = t1;
  lifecycleCaller = new $.ComponentItem(obj);
  lifecycleCaller.create$0();
  t1 = $.get$children$x($parent);
  t2 = obj._host;
...
dateChanged: function() {
  var monthNumber, t1, t2, year, i, id, headingElement, d, t3, t4, termineElement, x, output, encoded;
  if ($.lastSelectedDate == null || $.substring$2$s($.selectedDate, 0, 7) !== $.substring$2$s($.lastSelectedDate, 0, 7)) {
    $.Primitives_printString("dateChanged(): different month, updating view");
    ...
    for (i = 1; i <= $.maxDays; ++i) {
      ...
      if (headingElement != null) {
        ...
        t1 = $.$add$ns(d.millisecondsSinceEpoch, $.Duration$(1, 0, 0, 0, 0, 0).get$inMilliseconds());
        t2 = d.isUtc;
        if ($.abs$0$n(t1) > 8640000000000000)
          $.throwExpression(new $.ArgumentError(t1));
        if (t2 == null)
        ...
        t3.date;
        t4 = $.getInterceptor$x(headingElement);
        if ($.$gt$n(new $.DateTime(t1, t2).millisecondsSinceEpoch, t3.millisecondsSinceEpoch)) {
          t1 = t4.get$classes(headingElement);
          t1.add$1(t1, "after");
          t4 = t4.get$classes(headingElement);
          t4.remove$1(t4, "before");
        } else {
          t1 = t4.get$classes(headingElement);
          t1.add$1(t1, "before");
          t4 = t4.get$classes(headingElement);
          t4.remove$1(t4, "after");
        }
  ...
  document.body.scrollLeft = $.$mul$n($.$sub$n($.Primitives_parseInt($.substring$2$s($.selectedDate, 8, 10), null, null), 1), 250);
...
LinkedListNode: {"": "Object;_liblib3$_previous?,_liblib3$_next?,_liblib3$_list<,_liblib3$_value",
  get$next: function() {
  ...
  remove$0: function(_) {
    ...
    if (t1 != null)
      ...
      this._liblib3$_list.set$_head(t2);
    t1 = this._liblib3$_next;
    t2 = this._liblib3$_previous;
    if (t1 != null)
      t1.set$_liblib3$_previous(t2);
    else
      this._liblib3$_list.set$_tail(t2);
    this._liblib3$_next = null;
    this._liblib3$_previous = null;
    this._liblib3$_list = null;
  },
  get$remove: function(_liblib8$_receiver) {
    return new $.BoundClosure$i0(this, "remove$0", _liblib8$_receiver);
  }
},

LinkedList: {"": "IterableBase;_head?,_tail?,_liblib3$_length@",
  get$length: function(_) {
  ...
  get$add: function(_liblib8$_receiver) {
    return new $.BoundClosure$i1(this, "add$1", _liblib8$_receiver);
  },
...
LinkedListIterator: {"": "Object;_copy,_liblib3$_list<,_liblib3$_current,_pos",
  get$current: function() {
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (t1 < t3) {
        if (t1 < 0)
          throw $.ioore(t1);
        t1 = !$.$eq(t2[t1].get$_liblib3$_list(), this._liblib3$_list);
      } else
        t1 = false;
    } while (t1);
    t1 = this._pos;
  ...
  LinkedListIterator$1: function(_list) {
    var t1, node, i, i0;
    t1 = $.List_List(this._liblib3$_list._liblib3$_length, $.LinkedListNode);
    t1.$builtinTypeInfo = [$.LinkedListNode];
    this._copy = t1;
    node = this._liblib3$_list._head;
...
XPause: {"": "WebComponent_Observable0;_liblib15$_css,__e12,__e15,__e16,__e13<,_liblib15$__t,__e14<,time@,_liblib15$__$_data<,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    ...
    this.__e16 = $.$index$asx(t1.get$nodes(root), 1);
    this.__e15 = $.$index$asx($.get$nodes$x(this.__e16), 1);
    this.__e12 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e15), 1)), 1);
    __binding11 = this._liblib15$__t.contentBind$2(new $.XPause_created_autogenerated_closure(this), false);
    $.addAll$1$ax($.get$nodes$x(this.__e12), [document.createTextNode("\n                "), __binding11, document.createTextNode("\n              ")]);
    this.__e13 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(this.__e15), 1)), 3);
    this._liblib15$__t.listen$2($.get$onChange$x(this.__e13), new $.XPause_created_autogenerated_closure0(this));
    this._liblib15$__t.listen$2($.get$onInput$x(this.__e13), new $.XPause_created_autogenerated_closure1(this));
    ...
    this.__e14 = $.$index$asx($.get$nodes$x(this.__e15), 3);
    this._liblib15$__t.listen$2($.get$onChange$x(this.__e14), new $.XPause_created_autogenerated_closure4(this));
    this._liblib15$__t.listen$2($.get$onInput$x(this.__e14), new $.XPause_created_autogenerated_closure5(this));
    t1 = this._liblib15$__t;
    t1.oneWayBind$4;
    t1.children.push(new $.DomPropertyBinding(new $.XPause_created_autogenerated_closure6(this), new $.XPause_created_autogenerated_closure7(this), false, false, null));
    t1 = this._liblib15$__t;
    t2 = new $.Collapse(null, null, true, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t2.set$host(t2, this.__e15);
    t1.component$1;
    t1.children.push(new $.ComponentItem(t2));
    t2 = this._liblib15$__t;
    t1 = new $.Accordion(null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t1.set$host(t1, this.__e16);
    t2.component$1;
    t2.children.push(new $.ComponentItem(t1));
  ...
  set$name: function(_, value) {
    ...
    if (t1 != null)
      t1._addRead$3(this, 1, "_data");
    $.$indexSet$ax(this._liblib15$__$_data, "name", value);
    return value;
  },
  set$text: function(_, value) {
    ...
    if (t1 != null)
      t1._addRead$3(this, 1, "_data");
    $.$indexSet$ax(this._liblib15$__$_data, "text", value);
    return value;
  },
  timeForHeading$1: function(t) {
    var t1, t2, hour, minute;
...
XPause_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    var t1, t2, t3, t4, output, encoded;
    t1 = this.this_1;
    $.get$XPause_dirtyPauses().push(t1);
    t2 = $.XPause_connection;
    t3 = t1.get$time();
    t4 = $._activeObserver;
    if (t4 != null)
      t4._addRead$3(t1, 1, "_data");
    t1 = t1.get$_liblib15$__$_data();
    t2.send$2;
    t1 = $.makeLiteralMap(["time", $.toString$0(t3), "data", t1]);
    output = $.StringBuffer$("");
...
XPause_created_autogenerated_closure1: {"": "Closure;this_2",
  call$1: function($$event) {
    var t1, t2, t3;
    t1 = this.this_2;
    t2 = $.get$value$x(t1.get$__e13());
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t1, 1, "_data");
    $.$indexSet$ax(t1.get$_liblib15$__$_data(), "name", t2);
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure3: {"": "Closure;this_3",
  call$0: function() {
    ...
    if (t2 != null)
      t2._addRead$3(t1, 1, "_data");
    return $.$index$asx(t1.get$_liblib15$__$_data(), "name");
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure5: {"": "Closure;this_6",
  call$1: function($$event) {
    var t1, t2, t3;
    t1 = this.this_6;
    t2 = $.get$value$x(t1.get$__e14());
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t1, 1, "_data");
    $.$indexSet$ax(t1.get$_liblib15$__$_data(), "text", t2);
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure7: {"": "Closure;this_7",
  call$0: function() {
    ...
    if (t2 != null)
      t2._addRead$3(t1, 1, "_data");
    return $.$index$asx(t1.get$_liblib15$__$_data(), "text");
  },
  $isFunction: true
},
...
XPause_created_autogenerated_closure6: {"": "Closure;this_8",
  call$1: function(e) {
    var t1 = this.this_8;
    if (!$.$eq($.get$value$x(t1.get$__e14()), e))
...
Listener: {"": "TemplateItem;eventStream,_liblib16$_subscription,listener",
  insert$0: function(_) {
    this._liblib16$_subscription = this.eventStream.listen$1(this.listener);
  },
  remove$0: function(_) {
    this._liblib16$_subscription.cancel$0();
    this._liblib16$_subscription = null;
  }
},
...
_Watcher: {"": "Object;debugName,_getter,_liblib11$_callback,_lastValue",
  ...
  compareAndNotify$0: function() {
    ...
    if (this._liblib11$_compare$1(currentValue) === true) {
      oldValue = this._lastValue;
      this._update$1(currentValue);
      this._liblib11$_callback$1(new $.ChangeNotification(oldValue, currentValue, null));
      return true;
    }
    return false;
  },
  _liblib11$_compare$1: function(currentValue) {
...
_HashMapWatcher: {"": "_Watcher;debugName,_getter,_liblib11$_callback,_lastValue",
  _liblib11$_compare$1: function(currentValue) {
...
_OrderDependantMapWatcher: {"": "_Watcher;debugName,_getter,_liblib11$_callback,_lastValue",
  _liblib11$_compare$1: function(currentValue) {
...
_WatcherType: {"": "Object;_liblib11$_value",
  toString$0: function(_) {
    return "Enum." + this._liblib11$_value;
  }
},
...
WebComponent: {"": "Object;",
  ...
  composeChildren$0: function() {
    ...
    t2._cell = t2._liblib0$_map._first;
    for (; t2.moveNext$0();) {
...
ObservableMap: {"": "Observable;_map,_liblib9$_keys,_values,$$_observers,$$_changes,hashCode",
  get$keys: function() {
...
_ObservableMapKeyIterator: {"": "Object;_map,_liblib9$_keys,_liblib9$_hasNext",
  moveNext$0: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this._map, 1, "length");
    t1 = this._liblib9$_keys.moveNext$0();
    this._liblib9$_hasNext = t1;
    return t1;
  },
  get$current: function() {
    var key, t1;
    key = this._liblib9$_keys.get$current();
    t1 = $._activeObserver;
    if (t1 != null && this._liblib9$_hasNext === true)
...
_ObservableMapValueIterator: {"": "Object;_map,_liblib9$_keys,_values,_liblib9$_hasNext",
  moveNext$0: function() {
    ...
    this._liblib9$_hasNext = moreValues;
    return moreValues;
  },
  get$current: function() {
    if ($._activeObserver != null && this._liblib9$_hasNext === true) {
      var t1 = this._liblib9$_keys.get$current();
...
_ExpressionObserver: {"": "Object;_id<,_expression,_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib5$_value",
...
ObservableSet: {"": "IterableWorkaround_Observable;_liblib4$_map,_createMap,$$_observers,$$_changes,hashCode",
  contains$1: function(_, value) {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 2, value);
    return this._liblib4$_map.containsKey$1(value);
  },
  add$1: function(_, value) {
    var t1, t2, len;
  ...
  clear$0: function(_) {
    ...
    if (t1 != null) {
      ...
      t1 = false;
    if (t1) {
      for (t1 = this._liblib4$_map, t2 = $.get$iterator$ax(t1.get$keys()); t2.moveNext$0() === true;) {
        value = t2.get$current();
        $.notifyChange(this, 10, value, value, null);
      }
      $.notifyChange(this, 1, "length", $.get$length$asx(t1), 0);
    }
    $.clear$0$ax(this._liblib4$_map);
  },
  get$length: function(_) {
    var t1 = $._activeObserver;
    if (t1 != null)
  ...
  get$iterator: function(_) {
    return new $._ObservableSetIterator(this, $.get$iterator$ax(this._liblib4$_map.get$keys()), false);
  },
  ...
  toString$0: function(_) {
    var t1, value;
    if ($._activeObserver != null)
      for (t1 = $.get$iterator$ax(this._liblib4$_map.get$keys()); t1.moveNext$0() === true;) {
        value = t1.get$current();
        $._activeObserver._addRead$3(this, 2, value);
      }
    return $.toString$0($.toSet$0$ax(this._liblib4$_map.get$keys()));
  },
...
_ObservableSetIterator: {"": "Object;_liblib4$_set,_liblib4$_iterator,_hasNext",
  moveNext$0: function() {
    var t1, t2;
    t1 = this._liblib4$_set;
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "length");
    $.get$length$asx(t1._liblib4$_map);
    t1 = this._liblib4$_iterator.moveNext$0();
    this._hasNext = t1;
    return t1;
  },
  get$current: function() {
    var result, t1;
    result = this._liblib4$_iterator.get$current();
    t1 = $._activeObserver;
    if (t1 != null && this._hasNext === true)
      t1._addRead$3(this._liblib4$_set, 2, result);
    return result;
  }
}}],
...
Accordion: {"": "WebComponent;_liblib13$_css,_liblib13$__t,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
...
Collapse: {"": "WebComponent;_liblib14$_css,_liblib14$__t,_isShown,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
...
Isolate.$lazy($, "dirtyAppointments", "XAppointment_dirtyAppointments", "get$XAppointment_dirtyAppointments", function() {
  var t1 = $.List_List($, $.XAppointment);
  t1.$builtinTypeInfo = [$.XAppointment];
  return t1;
});
...
Isolate.$lazy($, "xpauses", "xpauses", "get$xpauses", function() {
  var t1 = $.List_List($, $.XPause);
  t1.$builtinTypeInfo = [$.XPause];
  return t1;
});
