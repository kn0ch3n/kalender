...
class XAppointment extends WebComponent {
  ...
  static final __html1 = new autogenerated.Element.html('<input type="text" placeholder="Name">'), __shadowTemplate = new autogenerated.DocumentFragment.html('''
  ...
  autogenerated.InputElement __e1, __e3;
  ...
  void created_autogenerated() {
    ...
    __e5 = __root.nodes[1];
    __e4 = __e5.nodes[1];
    __e2 = __e4.nodes[1].nodes[1];
    var __binding0 = __t.contentBind(() => heading, false);
    __e1 = __html1.clone(true);
    __t.listen(__e1.onInput, ($event) { name = __e1.value; });
    __t.oneWayBind(() => name, (e) { if (__e1.value != e) __e1.value = e; }, false, false);
  ...
  void removed_autogenerated() {
    __t.remove();
    __t = __e5 = __e4 = __e2 = __e1 = __e3 = null;
  }
